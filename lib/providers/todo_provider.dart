...
class TodoProvider with ChangeNotifier {
  ...
  void setRuhHali(int value) { _checkDailyReset(); ruhHali = value; notifyListeners(); }
  void setSigara(int value) { _checkDailyReset(); sigara = value; notifyListeners(); }
  void setKahve(int value) { _checkDailyReset(); kahve = value; notifyListeners(); }
  void setEkranSuresi(double value) { _checkDailyReset(); ekranSuresi = value; notifyListeners(); }
  void setAdim(int value) { _checkDailyReset(); adim = value; notifyListeners(); }
  void setSu(int value) { _checkDailyReset(); su = value; notifyListeners(); }
  void toggleCiltBakimi(bool value) { _checkDailyReset(); ciltBakimi = value; notifyListeners(); }
  void toggleOgun(int index) { _checkDailyReset(); ogunler[index] = !ogunler[index]; notifyListeners(); }
  void setUyku(double value) { _checkDailyReset(); uyku = value; notifyListeners(); }
  ...
  double get totalScore {
    ...
    if (ekranSuresi >= 0) earned += (10 - (ekranSuresi - 1)).clamp(0, 10);
  ...
  void loadFromMap(Map<String, dynamic>? data) {
    if (data == null) {
      _resetAll();
      isReadOnly = false; // Veri yoksa düzenleme açık kalsın
      notifyListeners();
      return;
    }
